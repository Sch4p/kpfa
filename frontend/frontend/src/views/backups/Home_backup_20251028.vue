<template>
  ...
  <div class="home-page">
    ...
    <div class="container my-5">
      ...
      <!--<section v-if="shopLoaded" class="mb-5 position-relative">-->
...
<section class="my-5">
  <h3 class="mb-4 text-center fw-bold text-success">Upcoming Match</h3>
  ...
  <div v-if="upcomingMatch" class="card shadow-sm p-4 border-0 mx-auto" style="max-width: 600px; background-color: #fff;">
    <div class="row align-items-center text-center">
      ...
      <div class="col-5 d-flex flex-column align-items-center">
        <img
          :src="upcomingMatch.away_team?.logo || '/images/opponent_placeholder.png'"
          alt="Away Team Logo"
          class="img-fluid mb-2"
          style="max-width: 70px;"
        />
