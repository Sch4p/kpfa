...
class TranslateView(APIView):
    def post(self, request):
        ...
        return Response({"translated_text": translated}, status=status.HTTP_200_OK)
...
class NewsViewSet(viewsets.ModelViewSet):
    ...
    def translated(self, request):
        ...
        for item in serializer.data:
            ...
            translated_item["title"] = translate_text(title, target_lang)
            translated_item["content"] = translate_text(content, target_lang)
