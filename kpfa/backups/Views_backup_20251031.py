...
class ShopItemViewSet(viewsets.ReadOnlyModelViewSet):
    queryset = ShopItem.objects.filter(stock_quantity__gt=0).order_by('-date_added')
    serializer_class = ShopItemSerializer
